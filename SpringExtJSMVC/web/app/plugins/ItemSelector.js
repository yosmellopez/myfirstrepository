Ext.define('Seleccion.plugins.ItemSelector', {
    extend: 'Seleccion.plugins.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['Seleccion.plugins.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'Seleccion.plugins.MultiSelect'
    ],
