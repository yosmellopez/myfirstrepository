Ext.apply(Ext.form.field.VTypes, {rangoFecha: function (val, field) {
        ...
        return true;
    }, rangoFechaText: 'La fecha de env\u00edo debe ser menor que la fecha de publicaci\u00f3n', vacio: function (val) {
