...
public class AutenticacionFallida extends SimpleUrlAuthenticationFailureHandler {
    ...
    public static final String LAST_USERNAME_KEY = "ultimoNombreUsuario";
    
    public static final String LAST_EXCEPTION = "mensajeExcepcion";
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        setDefaultFailureUrl("/inicioSesion.htm?error=true");
