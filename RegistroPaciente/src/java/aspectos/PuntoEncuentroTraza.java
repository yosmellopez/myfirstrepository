...
@Aspect
public class PuntoEncuentroTraza {
    ...
    @AfterReturning("execution(* controladoresSpring.*.*(..))")
        ...
        try {
            ...
            if (puedeInsertarse(url, metodo)) {
                ...
                if (authentication != null && authentication.isAuthenticated()) {
                    Object authenticado = authentication.getPrincipal();
            ...
            Logger.getLogger(PuntoEncuentroTraza.class.getName()).log(Level.SEVERE, null, e);
        }
