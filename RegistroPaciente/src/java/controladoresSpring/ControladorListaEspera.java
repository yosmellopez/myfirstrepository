...
@Controller
public class ControladorListaEspera {

    @Autowired
    ListaEsperaJpaController jpaController;

    @RequestMapping(value = "/listaEspera.json", method = RequestMethod.GET)
    @ResponseBody
    public ModelAndView listarListaEsperas(int start, int limit) {
    ...
    @RequestMapping(value = "/listaEspera.json", method = RequestMethod.POST)
    @ResponseBody
    public ModelAndView insertarListaEspera(@RequestBody ListaEspera objetoEntidad) {
    ...
    @RequestMapping(value = "/listaEspera.json/{idListaEspera}", method = RequestMethod.PUT)
    @ResponseBody
    public ModelMap actualizarListaEspera(@PathVariable int idListaEspera, @RequestBody ListaEspera objetoEntidad) {
        ListaEspera objetoBD = jpaController.actualizarEntidad(idListaEspera, objetoEntidad);
        ModelMap map = new ModelMap();
        map.put("success", true);
    ...
    @RequestMapping(value = "/listaEspera.json/{idListaEspera}", method = RequestMethod.DELETE)
    @ResponseBody
    public ModelMap eliminarListaEspera(@PathVariable int idListaEspera) {
        jpaController.eliminarEntidad(idListaEspera);
        ModelMap map = new ModelMap();
        map.put("success", true);
        return map;
    }
