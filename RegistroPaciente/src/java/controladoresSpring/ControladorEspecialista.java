...
import controladoresJpa.EspecialistaJpaController;
...
public class ControladorEspecialista {
    ...
    @Autowired
    EspecialistaJpaController jpaController;

    @Autowired
    RolJpaController rolJpaController;

    @RequestMapping(value = "/especialista.json", method = RequestMethod.GET)
    @ResponseBody
    public ModelAndView listarEspecialistas(int start, int limit) {
    ...
    @RequestMapping(value = "/especialista.json", method = RequestMethod.POST)
    @ResponseBody
    public ModelAndView insertarEspecialista(@RequestBody Especialista objetoEntidad) {
    ...
    @RequestMapping(value = "/especialista.json/{idEspecialista}", method = RequestMethod.PUT)
    @ResponseBody
    public ModelMap actualizarEspecialista(@PathVariable int idEspecialista, @RequestBody Especialista objetoEntidad) {
        Especialista objetoBD = jpaController.actualizarEntidad(idEspecialista, objetoEntidad);
        ModelMap map = new ModelMap();
        map.put("success", true);
    ...
    @RequestMapping(value = "/especialista.json/{idEspecialista}", method = RequestMethod.DELETE)
    @ResponseBody
    public ModelMap eliminarEspecialista(@PathVariable int idEspecialista) {
        jpaController.eliminarEntidad(idEspecialista);
        ModelMap map = new ModelMap();
        map.put("success", true);
        return map;
    }
