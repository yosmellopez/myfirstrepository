...
import controladoresJpa.AreaSaludJpaController;
...
@Controller
public class ControladorAreaSalud {
    ...
    @ResponseBody
    public ModelAndView insertarAreaSalud(@RequestBody AreaSalud objetoEntidad) {
    ...
    @ResponseBody
    public ModelMap actualizarAreaSalud(@PathVariable int idAreaSalud, @RequestBody AreaSalud objetoEntidad) {
        AreaSalud objetoBD = jpaController.actualizarEntidad(idAreaSalud, objetoEntidad);
        ModelMap map = new ModelMap();
        map.put("success", true);
