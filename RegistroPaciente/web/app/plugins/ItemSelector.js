Ext.define('Registro.plugins.ItemSelector', {
    extend: 'Registro.plugins.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['Registro.plugins.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'Registro.plugins.MultiSelect'
    ],
