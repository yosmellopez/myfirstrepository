Ext.define('Registro.plugins.GridSelector', {
    extend: 'Ext.form.FieldContainer',
    mixins: {field: 'Ext.form.field.Field'},
    alternateClassName: 'Registro.plugins.GridSelector',
    flexFrom: 0,
    flexTo: 0,
    blankText: 'El grid de seleccionar esta vacio',
    noSelectionText: 'Hay profesores sin seleccionar actividad',
