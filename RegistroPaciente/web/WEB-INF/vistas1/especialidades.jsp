...
<html>
    <head>
        ...
        <script type="text/javascript" src="appEspecialidad.js"></script>
    </head>
            ...
            <div class="span11">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <h2><i class="icofont-home"></i> Especialidades </h2>
                    </div><!-- /content-header -->
                    ...
                    <div class="content-breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Lista de Especialidad</li>
                        </ul><!--/breadcrumb-->
                            ...
                            <div class="span12">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Listado de especialidades</span>
                                    </div>
                                    <div class="box-body">
