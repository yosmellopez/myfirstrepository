...
<html>
    <head>
        ...
        <script type="text/javascript" src="appRecurso.js"></script>
    </head>
            ...
            <div class="span11">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <h2><i class="icofont-home"></i> Lista de Recursos para las Operaciones</h2>
                    </div><!-- /content-header -->
                    ...
                    <div class="content-breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Lista de Recursos</li>
                        </ul><!--/breadcrumb-->
                            ...
                            <div class="span12">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Lista de Recursos Para Operaciones</span>
                                    </div>
                                    <div class="box-body">
