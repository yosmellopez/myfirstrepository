...
<html>
    <head>
        ...
        <title>Gestion de Listas de Espera</title>
        <c:import url="/bloques/assets.jsp"/>
        <script type="text/javascript" src="appListaEspera.js"></script>
        <script type="text/javascript" src="appGrupo.js"></script>
    </head>
            ...
            <div class="span11">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <h2><i class="icofont-home"></i> Lista de Espera </h2>
                    </div><!-- /content-header -->
                            ...
                            <div class="span6">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Listado de Espera</span>
                                    </div>
                                    <div class="box-body">
                            ...
                            <div class="span6">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Listado de Grupos</span>
                                    </div>
                                    <div class="box-body">
                                        <div id="contenido" style="min-height: 500px"></div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- tab stat -->
