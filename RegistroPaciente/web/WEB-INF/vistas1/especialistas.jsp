...
<html>
    <head>
        ...
        <title>Gestion de Especialistas</title>
        <c:import url="/bloques/assets.jsp"/>
        <script type="text/javascript" src="appEspecialista.js"></script>
    </head>
            ...
            <div class="span11">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <h2><i class="icofont-home"></i> Especialistas </h2>
                    </div><!-- /content-header -->
                    ...
                    <div class="content-breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Lista de Especialista</li>
                        </ul><!--/breadcrumb-->
                            ...
                            <div class="span12">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Listado de Especialistas</span>
                                    </div>
                                    <div class="box-body">
