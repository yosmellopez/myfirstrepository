...
<html>
    <head>
        ...
        <script type="text/javascript" src="appUsuario.js"></script>
            ...
            <div class="span11">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <h2><i class="icofont-home"></i> Bienvenido al Sistema de Control de Pacientes</h2>
                    </div><!-- /content-header -->

                    <!-- content-breadcrumb -->
                    <div class="content-breadcrumb">
                        <ul class="breadcrumb">
                            <li><a href="index.htm#"><i class="icofont-home"></i> Inicio</a></li>
                        </ul><!--/breadcrumb-->
                            ...
                            <div class="span12">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Lista de Usuarios</span>
                                    </div>
                                    <div class="box-body">
