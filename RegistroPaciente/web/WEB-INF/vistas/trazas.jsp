...
<html>
    <head>
        ...
        <script type="text/javascript" src="trazas.js"></script>
    </head>
            ...
            <div class="span11">
                ...
                <div class="content">
                    ...
                    <div class="content-header">
                        <h2><i class="icofont-home"></i> Trazas </h2>
                    </div><!-- /content-header -->
                    ...
                    <div class="content-breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Lista de Trazas</li>
                        </ul><!--/breadcrumb-->
                            ...
                            <div class="span12">
                                <div class="box corner-all">
                                    <div class="box-header corner-top grd-white">
                                        ...
                                        <span><i class="icofont-user"></i> Listado de Trazas</span>
                                    </div>
                                    <div class="box-body">
