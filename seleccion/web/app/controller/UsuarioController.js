Ext.define('Seleccion.controller.UsuarioController', {
    extend: 'Ext.app.Controller',
    views: ['usuario.GridUsuario', 'usuario.NuevoUsuario', 'usuario.ModificarUsuario'],
    ...
    insertar: function (buton) {
        ...
        if (basicForm.isValid()) {
            ...
            record = Ext.create('Seleccion.model.Usuario', valores);
...
//        this.redirectTo('modificar/' + record.get('idUsuario'));
