Ext.define('Seleccion.view.aspirante.ModificarAspirante', {
    extend: 'Ext.window.Window',
    title: 'Editar Aspirante',
    alias: 'widget.modificarAspirante',
    modal: true,
    contador: 0,
    ...
    cargarDatos: function (datos) {
        elementos = this.query('[xtype=textfield],[xtype=numberfield],[xtype=textarea],[xtype=hiddenfield]');
        for (i = 0; i < elementos.length; i++) {
            elementos[i].setValue(datos[elementos[i].name]);
        }
    }
});
