Ext.define('Seleccion.view.entrevistaIndividual.InsertarEntrevistaIndividual', {
    extend: 'Ext.window.Window',
    title: 'Insertar Entrevista Individual',
    alias: 'widget.insertarEntrevIndiv',
    modal: true,
    paso: 0,
    viewModel: {
        data: {
...
//    controller: 'entrevistaIndividual',
