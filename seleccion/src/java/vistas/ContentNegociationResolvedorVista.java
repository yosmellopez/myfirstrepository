    ...
    private List<View> getCandidateViews(String viewName, Locale locale, List<MediaType> requestedMediaTypes)
        ...
        for (ViewResolver viewResolver : this.viewResolvers) {
            if (!(viewResolver instanceof JasperReportsViewResolver)) {
                ...
                if (viewName.equals("reporteControlAspirante") || viewName.equals("reporteCronogramaCurso") || viewName.equals("documentoAprobatorio") || viewName.equals("entrevistaIndividualReporte") || viewName.equals("resumenExpedienteReporte") || viewName.equals("resumenSicometrico") || viewName.equals("solicitudEmpleo") || viewName.equals("datos")) {
                    try {
                        View view = viewResolver.resolveViewName(viewName, locale);
                        if (view != null) {
                            candidateViews.add(view);
