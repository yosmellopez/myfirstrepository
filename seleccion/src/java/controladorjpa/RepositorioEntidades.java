...
public abstract class RepositorioEntidades<T, ID> {
    ...
    public RepositorioEntidades(Class classe) {
        this.clase = classe;
        ascendente = true;
    }
    ...
    private List<T> findWhere(Map<String, Object> h, boolean and) {
        ...
        consulta += where + " " + (null != orderby && orderby.isEmpty() ? " ORDER BY o." + orderBy + " DESC" : orderby);
    ...
    public void eliminarEntidad(ID id) {
        eliminarEntity((T) em.getReference(clase, id));
    }
